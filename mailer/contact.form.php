...
$recipientName = "waterlineindustries";

// Recipient email. Change this email to your
$recipientEmail = "mario@waterlineindustries.net";
...
if ($useSMTP) {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'mario@waterlineindustries.net';
    $mail->Password = 'vlkq dtij dmwt gxiz';
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;
} else {
